...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = create_sample_recipe(user=self.user, title="Test recipe 1")
        recipe2 = create_sample_recipe(user=self.user, title="Test recipe 2")
        tag1 = create_sample_tag(user=self.user, name="Tag1")
        tag2 = create_sample_tag(user=self.user, name="Tag2")
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = create_sample_recipe(user=self.user, title="Test recipe 3")
